...
from .views.product_views import shop_products
from .views.cart_views import add_to_cart, update_cart_item, view_cart
from .views.customer_views import checkout
from .views.admin_views import admin_add_product, admin_remove_product, admin_modify_product
